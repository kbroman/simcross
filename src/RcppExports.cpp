...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(convert2geno(xodat, map, founder_geno));
    return __result;
END_RCPP
}
// convert2genoarray
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const List >::type xodat(xodatSEXP);
    Rcpp::traits::input_parameter< const NumericVector >::type map(mapSEXP);
    __result = Rcpp::wrap(convert2genoarray(xodat, map));
    return __result;
END_RCPP
}
// convert2geno_char
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(convert2geno_char(xodat, map, founder_geno));
    return __result;
END_RCPP
}
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const NumericVector >::type map(mapSEXP);
    Rcpp::traits::input_parameter< const CharacterMatrix >::type founder_geno(founder_genoSEXP);
    __result = Rcpp::wrap(convert2geno_char_paste(xodat, map, founder_geno));
    return __result;
END_RCPP
}
// get_geno
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(get_geno(xodat, position));
    return __result;
END_RCPP
}
// sim_crossovers
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(sim_crossovers(L, m, p, obligate_chiasma, Lstar));
    return __result;
END_RCPP
}
// sim_meiosis
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const bool >::type obligate_chiasma(obligate_chiasmaSEXP);
    Rcpp::traits::input_parameter< const double >::type Lstar(LstarSEXP);
    __result = Rcpp::wrap(sim_meiosis(parent, m, p, obligate_chiasma, Lstar));
    return __result;
END_RCPP
}
