...
test_that("convert2geno works for 8-allele case", {
    ...
    # expected genotype matrix (force integers)
    expected <- rbind(c(512, 512, 260, 260, 512, 260, 258, 512, 512, 512, 512, 512,
                        64, 64, 64, 64, 64, 64, 64, 16, 16),
                      c(512, 512, 512, 512, 512, 8, 258, 512, 512, 512, 512, 512, 64,
                        64, 64, 64, 64, 64, 64, 16, 16),
                      c(512, 512, 260, 260, 512, 260, 258, 512, 512, 512, 512, 512,
                        64, 64, 64, 64, 64, 64, 64, 16, 16),
                      c(512, 512, 260, 512, 512, 8, 258, 512, 512, 512, 512, 512, 64,
                        64, 64, 64, 64, 64, 64, 16, 16))
    expected <- matrix(as.integer(expected), nrow=4)
    dimnames(expected) <- list(as.character(1:4), paste0("marker", 1:21))
