...
To simulate genotypes for the DO, we need to duplicate those founder
genotypes, with female founders as 1-8 and male founders as 9-16.

```{r duplicate_founder_geno}
for(i in seq(along=fg))
    fg[[i]] <- rbind(fg[[i]], fg[[i]])
```

And now here is the simulation of a small DO population for multiple chromosomes.
