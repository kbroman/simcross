...
the [QTLRel package](http://cran.r-project.org/package=QTLRel).
...
[A Multiparent Advanced Generation Inter-Cross to fine-map quantitative traits in _Arabidopsis thaliana_](http://www.plosgenetics.org/article/info%3Adoi%2F10.1371%2Fjournal.pgen.1000551).
...
Mott R, Flint J (2002)
[Simultaneous detection and fine mapping of quantitative trait loci in mice using heterogeneous stocks](http://www.genetics.org/content/160/4/1609.short).
